  ...
  <div class="app-container">
    <el-form>
      <el-form-item>
        ...
        <el-button type="primary" round="true" @click="begin()">
    ...
    <el-table
      ...
      <el-table-column label="结束时间" align="center">
        <template slot-scope="scope">
          {{ scope.row.createtime === scope.row.modifiedtime ? '' : ''+scope.row.modifiedtime }}
          <el-button v-if="scope.row.note === null" type="primary" @click="stop(scope.row.userId)">结束</el-button>
        </template>
      </el-table-column>
    </el-table>
  </div>
...
export default{
  ...
  methods: {
    begin() {
      freeFitness.addNewFreeFitnessMessage(this.userInfo.userId).then(response => {
        this.init()
      })
    },
    stop() {
