<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column prop="coachName" label="名称" width="80" align="center"/>
      <el-table-column label="头衔" width="80">
        <template slot-scope="scope">
          {{ scope.row.type===0?'普通教练':'特约教练' }}
        </template>
      </el-table-column>
      <el-table-column prop="coachBalance" label="余额" width="60" align="center" />
      <el-table-column prop="sort" label="排序" width="60" align="center" />
      <el-table-column prop="intro" label="介绍" length="120" align="center" />
