<template>
  <div class="app-container">
    ...
    <el-table
      ...
      <el-table-column prop="coachName" label="教练" width="180" align="center"/>
...
export default {
  ...
  methods: { // 创建具体的方法，调用accountBook.js定义的方法
    init() {
      this.accountBookQuery.coachId = this.Id
      this.getList()
      this.coachListinit()
    },
    getList(page = 1) {
      this.page = page
      accountBook.getCoachListPage(this.page, this.limit, this.accountBookQuery)
        .then(response => { // 请求成功
          // response接口返回的数据
